...
int main (void) {
  ...
  // test construction from Proto_Cell
  {
    ...
    const vector<dir_type> dirs{Constants::X_NEG, Constants::X_POS, 
      Constants::Y_NEG, Constants::Y_POS, Constants::Z_NEG, Constants::Z_POS};
    ...
    vector<Constants::bc_type> bcs {Constants::REFLECT, Constants::VACUUM, 
      Constants::ELEMENT, Constants::PROCESSOR, Constants::ELEMENT, 
      Constants::VACUUM};
    ...
    if (proto_construction_pass) cout<<"TEST PASSED: construction from Proto_Cell"<<endl;
    else { 
